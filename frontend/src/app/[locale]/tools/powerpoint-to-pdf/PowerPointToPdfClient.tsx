      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebApplication",
            name: isZh ? "PowerPoint 转 PDF 转换器" : "PowerPoint to PDF Converter",
            operatingSystem: "All",
            ...
            mainEntity: isZh ? [
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "我们的服务器使用 Gotenberg——基于 LibreOffice Impress 的无头转换服务。当您上传 PowerPoint 演示文稿时，文件直接流式传入隔离的纯内存沙箱，由 LibreOffice Impress 处理后流式返回为 PDF——您的文件永不触碰磁盘。每张幻灯片渲染为一整页 PDF；字体、嵌入图片、形状与母版样式均会被保留。",
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "不会。PDF 是静态格式，无法表达动画、幻灯片切换、视频或音频播放。转换时每张幻灯片会被渲染到最终视觉状态：所有「单击出现」元素被完整展示，切换效果被剥离，嵌入视频缩减为封面帧。",
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "结合 5 秒超时限制，5MB 的文件大小限制确保了快速转换和资源公平共享。演示文稿之所以容易变大，多因嵌入高分辨率图片和视频。请先用「压缩图片」功能压缩嵌入图像，或把长篇演示按章节拆分。",
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "是的。我们实施零占用（Zero-Footprint）策略：文件完全在服务器内存中使用流式管道处理，从不写入磁盘。所有转换操作都在隔离的内存空间中进行，转换完成后内存缓冲区会立即释放。",
                },
              },
              {
                "@type": "Question",
                name: "支持哪些 PowerPoint 格式？",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "我们支持两种主要的 PowerPoint 格式：.pptx（Office Open XML 格式，自 Microsoft Office 2007 起成为标准）和传统的 .ppt 格式。建议先在 PowerPoint 中嵌入字体（文件 → 选项 → 保存 → 在文件中嵌入字体）以避免服务器侧字体替换。",
                },
              },
              {
                "@type": "Question",
            ...
            ] : [
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Our server uses Gotenberg, a powerful document conversion service powered by LibreOffice Impress. When you upload a PowerPoint presentation, it streams directly to memory, gets processed by LibreOffice Impress, and streams back as PDF. Each slide is rendered as a full PDF page; typography, embedded images, shapes, and slide masters are preserved. Your file never touches disk — this is a true memory-only pipeline architecture.",
                },
              },
              {
                "@type": "Question",
                name: "Are animations and slide transitions preserved?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "No. PDF is a static format and cannot represent animations, slide transitions, embedded video, or audio playback. During conversion, each slide is rendered to its final visual state: any \"appear on click\" elements are shown in full, transitions are stripped, and embedded video frames are reduced to their poster image.",
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Combined with the 5-second timeout, the 5MB limit ensures fast conversions and fair resource sharing. Presentations grow large because of embedded media. Compress images via PowerPoint's Compress Pictures feature or split long decks into chapters.",
                },
              },
              {
                "@type": "Question",
                name: "Is my presentation secure during conversion?",
                acceptedAnswer: {
                  "@type": "Answer",
              ...
              },
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "We support .pptx (Office Open XML, the standard since 2007) and the legacy .ppt format. For best results, use .pptx with standard fonts. Embed fonts inside the .pptx (File → Options → Save → Embed fonts in the file) to avoid server-side font substitution.",
                },
              },
              {
                "@type": "Question",
      ...
      <div className="max-w-4xl mx-auto px-6 py-section">
        ...
        >
          <input
            ...
            className="hidden"
          />
          <Presentation className="w-12 h-12 mx-auto mb-4 text-primary" strokeWidth={1.5} />
        ...
        <div className="mt-8">
          <ShareButtons
            title={{
              en: "Just converted a .pptx to PDF in 5 seconds — zero upload, memory-only pipeline. All-in-One Toolbox.",
              zh: "刚刚 5 秒内把 .pptx 转成 PDF —— 零上传、纯内存管道。All-in-One Toolbox。",
            }}
            eyebrow={{
